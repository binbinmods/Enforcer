...
using UnityEngine;
using static CharacterToBeReplaced.CustomFunctions;
using static CharacterToBeReplaced.Plugin;
using static CharacterToBeReplaced.DescriptionFunctions;
using static CharacterToBeReplaced.CharacterToBeReplacedFunctions;
using System.Text;
using TMPro;
...
namespace CharacterToBeReplaced
{
    ...
    internal class Traits
    {
        ...
        // //     if ((__instance != null && __instance.CardData != null && (__instance.CardData.Id == "Enforcerformula" || __instance.CardData.CardName == "Recompilation Formula")) || id == "Enforcerformula")
        // //     {
        ...
        // //     if (__instance != null && __instance.CardData != null && (__instance.CardData.Id == "Enforcerformula" || __instance.CardData.CardName == "Recompilation Formula"))
        // //     {
